...
**Generated:** 2026-09-21 09:20:52 UTC  
**Evaluated Test Population:** 20 transactions  
...
|---|---|---|---|---|---|---|---|---|---|
| **Micro (< $20)** | 11 | 5 | 45.45% | 3 | 27.27% | `0.64` | **FLAGGED (Risk Concentration)** | 0.00% | `1.00` |
| **Standard ($20 - $200)** | 7 | 3 | 42.86% | 3 | 42.86% | `1.00` | PASSED | 0.00% | `1.00` |
| **Large ($200 - $1,000)** | 2 | 2 | 100.00% | 2 | 100.00% | `2.33` | **FLAGGED (Risk Concentration)** | 0.00% | `1.00` |
...
|---|---|---|---|---|---|---|---|---|---|
| **Essential (Grocery/Pharmacy)** | 0 | 0 | 0.00% | 0 | 0.00% | `1.00` | PASSED | 0.00% | `1.00` |
| **Discretionary (Retail/Dining/Travel)** | 19 | 10 | 52.63% | 8 | 42.11% | `42.10` | **FLAGGED (Category Risk)** | 0.00% | `0.00` |
| **High-Risk (Digital/Crypto/Electronics)** | 1 | 0 | 0.00% | 0 | 0.00% | `0.00` | **FLAGGED (Category Risk)** | 0.00% | `0.00` |
...
|---|---|---|---|---|---|---|---|---|---|
| **Daytime / Business Hours (08:00 - 20:00)** | 11 | 5 | 45.45% | 4 | 36.36% | `1.00` | PASSED | 0.00% | `1.00` |
| **Off-Hours / Overnight (20:00 - 08:00)** | 9 | 5 | 55.56% | 4 | 44.44% | `1.22` | PASSED | 0.00% | `1.00` |
